...
public enum ErrorCode {
    ...
    //회원가입 관련 에러코드
    VALIDATAION_FAIL_JOIN_ID(400, "ERR-VALID-MEM-01", "아이디는 4~16자리여야 합니다."),
    VALIDATAION_FAIL_JOIN_NNM(400, "ERR-VALID-MEM-02", "닉네임은 4~14자 한글만 가능합니다."),
    ...
    //이메일 인증 관련
    EMAIL_SEND_FAIL(400, "ERR-EAUTH-CS-01", "이메일 전송에 실패하였습니다. 관리자에게 문의하세요."),
